...
func (c *Client) ForecastLocation (coordinate model.Coordinate) ([]*model.Forecast, error) {
    ...
    url  = fmt.Sprintf(url, strconv.FormatFloat(coordinate.Latitude, 'f', -5, 64), strconv.FormatFloat(coordinate.Longitude, 'f', -5, 64), c.forecastDays, c.windSpeedUnit, c.timeFormat, c.measurements)
